...
| 05 | `05-infrastructure-operations.md` | Infrastructure & Ops | cloud, DevOps, server, network, database, Kubernetes, deploy, AWS, Azure, GCP, CI/CD, Docker | 15 |
| 06 | `06-management-organization.md` | Management | project management, agile, scrum, leadership, strategy, product, roadmap, sprint, backlog | 17 |
| 07 | `07-quality-testing.md` | QA & Testing | test, quality, QA, test automation, performance, regression, E2E, unit test, integration | 10 |
| 08 | `08-marketing-digital-content.md` | Marketing & Content | marketing, SEO, social media, content, campaigns, brand, ads, SEM, email, growth, copywriting | 25 |
| 09 | `09-ecommerce-marketplace.md` | E-commerce | e-commerce, marketplace, Amazon, catalog, online sales, Shopify, WooCommerce, pricing | 10 |
| 10 | `10-sales-customer-success.md` | Sales & CS | sales, CRM, customer success, onboarding, revenue, churn, renewal, pre-sales | 10 |
